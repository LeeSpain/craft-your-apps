      ...
      <div className="container mx-auto">
        ...
        <Motion delay={400}>
          <div className="mt-16 p-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl text-white text-center">
            ...
            <div className="inline-flex items-center justify-center px-6 py-3 border-2 border-white text-lg font-medium rounded-lg hover:bg-white hover:text-purple-600 transition-colors cursor-pointer">
